    ...
    public function run()
    {
        ...
        \DB::table('data_rows')->insert(array (
            ...
            array (
                'id' => 72,
                'data_type_id' => 9,
                'field' => 'contact_message_id',
                'type' => 'text',
                'display_name' => 'Contact Message Id',
                'required' => 1,
                'browse' => 0,
                'read' => 0,
                'edit' => 0,
            ...
            array (
                'id' => 78,
                'data_type_id' => 9,
                'field' => 'response_message_belongsto_contact_message_relationship',
                'type' => 'relationship',
                'display_name' => 'contact_messages',
                'required' => 0,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
                'add' => 1,
                'delete' => 1,
                'details' => '{"model":"App\\\\ContactMessage","table":"contact_messages","type":"belongsTo","column":"contact_message_id","key":"id","label":"id","pivot_table":"categories","pivot":"0","taggable":"0"}',
                'order' => 6,
            ),
        ));
